...
import StyledQRCode, { type StyledQRCodeRef } from '@/components/qr/StyledQRCode'
import { useQRGenerator } from '@/hooks/use-qr-generator'
import { detectDataType, generateWiFiQR, generateVCardQR } from '@/lib/qr-utils'
...
export default function QRGenerator() {
  ...
  const [dataType, setDataType] = useState<'text' | 'url' | 'email' | 'phone' | 'wifi' | 'vcard'>('url')
  ...
  const handleDataTypeChange = (type: typeof dataType) => {
    ...
    switch (type) {
      ...
      case 'phone':
        ...
        break
      case 'wifi':
        const wifiQRData = generateWiFiQR(wifiData.ssid || 'MyWiFi', wifiData.password || '', wifiData.security)
  ...
  const handleWifiUpdate = (field: keyof typeof wifiData, value: string) => {
    ...
    updateQRState({ data: generateWiFiQR(newWifiData.ssid, newWifiData.password, newWifiData.security) })
  }
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-2">
                  <Button onClick={() => handleDownload('png')} disabled={isGenerating}>
                    <Download className="w-4 h-4 mr-2" />
                    PNG
                  </Button>
                  <Button onClick={() => handleDownload('svg')} variant="outline" disabled={isGenerating}>
                    <Download className="w-4 h-4 mr-2" />
                    SVG
                  </Button>
                </div>
                <Button onClick={handleCopy} variant="outline" className="w-full" disabled={isGenerating}>
                  <Copy className="w-4 h-4 mr-2" />
                  Copy to Clipboard
                </Button>
                <Button onClick={handleRandomize} variant="outline" className="w-full">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => handleDataTypeChange(value as typeof dataType)}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        id="ssid"
                        value={wifiData.ssid}
                        onChange={(e) => handleWifiUpdate('ssid', e.target.value)}
                        placeholder="My WiFi Network"
                      />
                    </div>
                    <div>
                      <Label htmlFor="security">Security</Label>
                      <Select value={wifiData.security} onValueChange={(value) => handleWifiUpdate('security', value)}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleWifiUpdate('password', e.target.value)}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVCardUpdate('firstName', e.target.value)}
                        placeholder="John"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVCardUpdate('lastName', e.target.value)}
                        placeholder="Doe"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVCardUpdate('email', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVCardUpdate('phone', e.target.value)}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleVCardUpdate('organization', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        id="vcardUrl"
                        value={vcardData.url}
                        onChange={(e) => handleVCardUpdate('url', e.target.value)}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder={
                      ...
                      dataType === 'email' ? 'contact@example.com' :
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      id="backgroundColor"
                      type="color"
                      value={qrState.backgroundColor === 'transparent' ? '#ffffff' : qrState.backgroundColor}
                      onChange={(e) => updateQRState({ backgroundColor: e.target.value })}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => updateQRState({ dotsColor: e.target.value })}
                      className="w-16 h-10 p-1 border rounded"
                    />
                    <Input
                      value={qrState.dotsColor}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => updateQRState({ cornersSquareColor: e.target.value })}
                      className="w-16 h-10 p-1 border rounded"
                    />
                    <Input
                      value={qrState.cornersSquareColor}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => updateQRState({ cornersDotColor: e.target.value })}
                      className="w-16 h-10 p-1 border rounded"
                    />
                    <Input
                      value={qrState.cornersDotColor}
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateQRState({ height: value })}
                    min={200}
                    max={800}
                    step={50}
                    className="mt-2"
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateQRState({ borderRadius: value })}
                    min={0}
                    max={50}
                    step={5}
                    className="mt-2"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateQRState({ margin: value })}
                    min={0}
                    max={50}
                    step={5}
                    className="mt-2"
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateQRState({ logoMargin: value })}
                    min={0}
                    max={20}
                    step={1}
                    className="mt-2"
              ...
              <div>
                ...
                <Select value={qrState.errorCorrectionLevel} onValueChange={(value) => updateQRState({ errorCorrectionLevel: value as any })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-3 gap-6">
                {/* Dots type */}
                <div>
                  <Label className="text-sm font-medium mb-3 block">Dots type</Label>
                    ...
                    {[
                      ...
                      <div key={value} className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => updateQRState({ dotsType: e.target.value as any })}
                          className="w-4 h-4"
                        />
                        <Label htmlFor={`dots-${value}`} className="text-sm cursor-pointer">
                          {label}
                        </Label>
                      </div>
                    ))}
                ...
                {/* Corners Square type */}
                <div>
                  <Label className="text-sm font-medium mb-3 block">Corners Square type</Label>
                  <div className="space-y-2">
                    {[
                      { value: 'dot', label: 'dot' },
                      { value: 'square', label: 'square' },
                      ...
                      <div key={value} className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => updateQRState({ cornersSquareType: e.target.value as any })}
                          className="w-4 h-4"
                        />
                        <Label htmlFor={`corners-square-${value}`} className="text-sm cursor-pointer">
                          {label}
                        </Label>
                      </div>
                    ))}
                ...
                {/* Corners Dot type */}
                <div>
                  <Label className="text-sm font-medium mb-3 block">Corners Dot type</Label>
                  <div className="space-y-2">
                    {[
                      { value: 'dot', label: 'dot' },
                      { value: 'square', label: 'square' }
                      ...
                      <div key={value} className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => updateQRState({ cornersDotType: e.target.value as any })}
                          className="w-4 h-4"
                        />
                        <Label htmlFor={`corners-dot-${value}`} className="text-sm cursor-pointer">
                          {label}
                        </Label>
                      </div>
                    ))}
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  id="logoUrl"
                  value={qrState.logo || ''}
                  onChange={(e) => updateQRState({ logo: e.target.value || undefined })}
              ...
              {qrState.logo && (
                <div>
                  <Label>Logo Size: {Math.round(qrState.logoSize * 100)}%</Label>
                  <Slider
                    value={[qrState.logoSize]}
                    onValueChange={([value]) => updateQRState({ logoSize: value })}
                    min={0.1}
                    max={0.8}
                    step={0.1}
                    className="mt-2"
